...
export default function Layout() {
  return (
    <div className="min-h-screen bg-slate-100">
      ...
      <main className="mx-auto max-w-5xl px-4 py-4 pb-20 sm:py-6 sm:pb-6">
        <Outlet />
      </main>

      {/* Mobile bottom tab bar - visible only on mobile */}
      <nav className="fixed bottom-0 left-0 right-0 z-10 border-t border-slate-200 bg-white/95 backdrop-blur-md sm:hidden safe-area-bottom">
